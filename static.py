...
def getGtAreaAndRatio(label_dir):
    """得到不同尺度的gt框个数 :params label_dir: label文件地址 :return data_dict: {dict: 3}  3 x {'类别':{’area':[...]},
    {'ratio':[...]}}.
    """
    data_dict = {}
...
def getAllSMLGtNum(data_dict, isEachClass=False):
    """数据集所有类别小、中、大GT分布情况 isEachClass 控制是否按每个类别输出结构."""
    S, M, L = 0, 0, 0
...
if __name__ == "__main__":
    labeldir = r"datasets/gwhd_2021_yolo/labels/train"  # 数据集标签路径
